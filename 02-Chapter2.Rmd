...
```{r constructionA, echo = FALSE, fig.cap = 'PVC didgeridoo construction, part A'}
knitr::include_graphics("img/constructionA.png")
```

Next, join the pipe (B) to the trap adapter base (C).
```{r constructionB, echo = FALSE, fig.cap = 'PVC didgeridoo construction, part B'}
...
```{r constructionC, echo = FALSE, fig.cap = 'PVC didgeridoo construction, part C'}
