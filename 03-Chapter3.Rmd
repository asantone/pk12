...
```{r tempDataViz, echo = FALSE, fig.cap = 'Global Average Temperature by Year, United States', fig.width=6, out.width = '50%',fig.align="center"}
knitr::include_graphics("img/tempDataPlot.png")
```
